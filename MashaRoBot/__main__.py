...
PM_START_TEXT = """
`Hellow`*{}* [🤗](https://telegra.ph/file/2e147376a5953bbd6cf3c.jpg) `My name is` *𓊈𒆜𝙿𝚁𝙸𝙽𝙲𝙴𝚂𝚂𒆜𓊉*
...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="🔎FOUNDER🔎", callback_data="devmenu_"),
    ],
    [
...
HELP_STRINGS = """
`Hi.. I'm` [𓊈𒆜𝙿𝚁𝙸𝙽𝙲𝙴𝚂𝚂𒆜𓊉🙋‍♀️](https://telegra.ph/file/2e147376a5953bbd6cf3c.jpg)
`Click on the buttons below to get documentation about specific modules..`"""


MASHA_IMG = "https://telegra.ph/file/2e147376a5953bbd6cf3c.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project, But We Dont want a mony just support us 🙃 \
 Supporting isnt always financial! \
 DEVELOPER [🧍🧍🧍DEV](https://t.me/Mr_Purushottam_M)"""
...
def Masha_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "masha_":
        query.message.edit_text(
            text=""" ༆ Hey {first} ⚡I'm * 𓊈𒆜𝙿𝚁𝙸𝙽𝙲𝙴𝚂𝚂𒆜𓊉*,A powerful group management bot built to help you manage your group easily.
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="➪GROUP⌫", callback_data="group_cmds"
                        ),
                        InlineKeyboardButton(
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm * 𓊈𒆜𝙿𝚁𝙸𝙽𝙲𝙴𝚂𝚂𒆜𓊉*
                 \nHere is the [💫My Founder💫](https://t.me/Mr_Purushott_M) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def get_help(update: Update, context: CallbackContext):
    ...
    if chat.type != chat.PRIVATE:
        if len(args) >= 2 and any(args[1].lower() == x for x in HELPABLE):
            ...
            return
        update.effective_message.reply_text(
            "🚶⚡Hey {first} Contact me in PM to get the list of possible commands.🚶⚡",
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1711642802 and DONATION_LINK:
            update.effective_message.reply_text(
                "You can also donate or Support to the person currently running me "
